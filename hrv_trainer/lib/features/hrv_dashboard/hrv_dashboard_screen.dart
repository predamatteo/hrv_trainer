        ...
        Row(
          children: [
            ...
            const InfoButton(
              ...
              entries: [
                GlossaryEntry('HRV',
                    'Quanto il cuore è elastico e reattivo. Più è alta, meglio il corpo recupera.'),
                GlossaryEntry('Coerenza',
                    'Quanto il battito oscilla pulito seguendo il respiro: il segnale che sei in sintonia col ritmo.'),
                GlossaryEntry('Prontezza',
                    'Se oggi il corpo è carico o riposato, rispetto al tuo solito.'),
                GlossaryEntry('Risonanza',
                    'Il tuo ritmo di respiro "giusto", dove il cuore oscilla di più — la tua altalena.'),
              ],
            ),
          ],
        ),
